...
final class CreateConfigConjuntosFretesNegar extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table = $this->table('tb_config_conjuntos_fretes_negar', ['id'=>false, 'collation' => 'utf8mb4_swedish_ci']);
