...
final class CreateSeoAcessos extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table = $this->table('tb_seo_acessos', ['id'=>false, 'primary_key' => ['id','id_seo'], 'collation' => 'utf8mb4_swedish_ci']);
        $table  ->addColumn('id',                   'biginteger', ['identity'=>true])
                ...
                ->addColumn('origem',               'text',    ['null'=>true])
