...
final class CreateProdutosConjuntosAtributos extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change(): void
    {
        ...
        $table = $this->table('tb_produtos_conjuntos_atributos', ['id'=>false, 'primary_key'=>['id','id_produto'],'collation' => 'utf8mb4_swedish_ci']);
        $table  ->addColumn('id',                           'biginteger',   ['identity'=>true])
                ...
                ->addColumn('descricao_aviso_desabilitado', 'text',         ['null'=>true])
