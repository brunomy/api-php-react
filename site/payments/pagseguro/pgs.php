...
class pgs {
     ...
     */
    function mostra($args = array(), $frete = null, $cupom = 0) {
        ...
        if ($args['open_form'])
            $_form[] = '<form name="frmPagSeguro" target="_self" action="https://pagseguro.uol.com.br/security/webpagamentos/webpagto.aspx" method="post">';
        ...
        foreach ($this->_cliente as $key => $value) {
            ...
            $this->_parametros["cliente_$key"] = $value;
        }
        ...
        foreach ($this->_itens as $item) {
            ...
            foreach ($assoc as $key => $value) {
                ...
                $this->_parametros[$value . $sufixo] = $item[$key];
            ...
            $this->_parametros['item_valor' . $sufixo] = sprintf('%.2f', $item['valor']);
            ...
            $this->_parametros["item_{$key}{$sufixo}"] = $value;
        ...
        if ($frete['valor'] !="") {
            $_form[] = "<input type='hidden' name='item_frete_1' value='".($frete['valor'] * 100)."'>";
        }
        
        if ($cupom != 0) {
            $_form[] = "<input type='hidden' name='extras' value='".($cupom * 100)."'>";
        }
        ...
        if ($args['show_submit']) {
            ...
            if ($args['img_button']) {
                ...
                switch ($args['btn_submit']) {
                    ...
                    case 1: $btn = 'btnComprarBR.jpg';
                        break;

                    case 2: $btn = 'btnPagarBR.jpg';
                        break;

                    case 3: $btn = 'btnPagueComBR.jpg';
                        break;

                    case 4: $btn = 'btnComprar.jpg';
                        break;

                    case 5: $btn = 'btnPagar.jpg';
                        break;
