        ...
        <div class="container error-container">
            <div class="error-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-body">
                    ...
                    <h2 class="text-center mt30 mb30">A página não pode ser encontrada.</h2>
                    <div class="text-center">
                        <a href="javascript: history.go(-1)" class="btn btn-default mr10"><span class="icomoon-icon-arrow-left-10 s16"></span>Voltar</a>
                        <a href="<?php echo $sistema->root_path;?>" class="btn btn-default"><span class="icomoon-icon-screen s16"></span>Home</a>
                    </div>
                </div>
            </div>
        </div>
