...
.frete .resultados .option-frete .valor span { color: <?php echo $color_main_green; ?>; }
.checkout_forms .resultados .option-frete .prazo span,
.frete .resultados .option-frete .prazo span { font-weight: normal; color: <?php echo $color_main_red; ?>; }
...
.cartao_cielo .total {
    ...
    font-weight: bold;
    text-align: center;
    color: <?php echo $color_main_gray ?>;
}
.cartao_cielo .titulo {
    padding-top: 0;
    margin-top: -5px;
...
.tipo_cliente_popup {
    ...
    padding: 20px;
    margin: 0 auto;
    border-top: 5px solid <?php echo $color_main_red ?>;
    background: #fff;
    text-align: center;
    color: <?php echo $color_main_gray ?>;
}
