...
if (!$validacao->return) {
    ...
    if ($query->query) {
        ...
        if ($emails->num_rows) {
            ...
            $assunto = "Formulário de Contato. [$formulario->nome]";  //Assunto da mensagem de contato.
            ...
            $body = str_replace("{TELEFONE}", $formulario->fone, $body);
...
function validaFormulario($form) {
    ...
    if ($form->nome == "") {
        ...
        return $resposta;
    } else if (!$sistema->cleanText($form->nome)) {
        $resposta->type = "validation";
        $resposta->message = "Caracteres não permitidos neste campo.";
        $resposta->field = "nome";
        $resposta->return = false;
        return $resposta;
    } else if ($form->fone == "") {
