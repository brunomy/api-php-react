...
(function ($) {
    $.fn.clickform = function (options, callback) {
        ...
        $styles.loadingSpan = {
            ...
            "background": "url(images/loaders/circular/010.gif) no-repeat 15px 14px #efefef",
        ...
        $styles.successSpan = {
            ...
            "background": "url(images/icon_clickform_success.png) no-repeat 12px 17px #6f8450",
        ...
        $styles.errorSpan = {
            "display": "inline-block",
            "padding": "15px 20px 15px 35px",
            "background": "url(images/icon_clickform_error.png) no-repeat 12px 17px #b9110d",
        ...
        $styles.attentionSpan = {
            "display": "inline-block",
            "padding": "15px 20px 15px 35px",
            "background": "url(images/icon_clickform_attention.png) no-repeat 12px 17px #f8d61a",
        ...
        function validateMessage($cf) {
            ...
            $("select").next("span.click-form").css("margin-top", "-21px");
        ...
        function blockTheForm($cf) {
            $cf.divs.blockerMessage = $("<div style=\"display:none;\"><span><a style='color:#a7acae; text-decoration:none' href='" + document.URL + "'>aguarde carregando</a></span></div>").prependTo("body");
