...
InformacaoDestaque::setAction();

class InformacaoDestaque extends Bootstrap {

    public $module = "";
    public $permissao_ref = "banners";
    public $table = "tb_informacao_destaque";
    ...
    function __construct() {
        ...
        $this->module_link = "informacaodestaque";
        $this->module_title = "Informação em Destaque";
        $this->retorno = "informacaodestaque";
        ...
        if (!$validacao->return) {
            ...
            $data = $this->formularioObjeto($_POST, $this->table);
                ...
                if ($query) {
                    ...
                    $this->inserirRelatorio("Alterou Informação Destaque");
                } else {
                    $resposta->type = "error";
    ...
    private function validaFormulario($form) {
        ...
        if ($form->texto == "" && $form->descricao == '') {
            $resposta->type = "validation";
            $resposta->message = "Título ou Descrição precisa ser preenchido";
