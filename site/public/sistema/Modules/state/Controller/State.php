...
class State extends Bootstrap {

    public $module = "";
    public $permissao_ref = "configuracoes";
    public $table = "tb_config_estados";
    ...
    function __construct() {
        ...
        $this->module_icon = "entypo-icon-map";
        $this->module_link = "state";
        $this->module_title = "Estados";
        $this->retorno = "state";
    }
    ...
    private function delAction() {
        ...
        $query = $this->DB_fetch_array("SELECT * FROM tb_config_cidades WHERE id_estado  = {$dados->rows[0]['id']}");
        if ($query->num_rows) {
            echo 'error';
            exit;
        }

        $this->inserirRelatorio("Apagou estado: [" . $dados->rows[0]['nome'] . "] id: [$id]");
        ...
        if (!$validacao->return) {
            ...
            if ($formulario->id == "") {
                ...
                if ($query->query) {
                    ...
                    $this->inserirRelatorio("Cadastrou estado: [" . $data->nome . "]");
                } else {
                    $resposta->type = "error";
                ...
                if ($query) {
                    ...
                    $this->inserirRelatorio("Alterou estado: [" . $data->nome . "]");
                } else {
                    $resposta->type = "error";
                    $resposta->message = "Aconteceu um erro no sistema, favor tente novamente mais tarde!";
                }
