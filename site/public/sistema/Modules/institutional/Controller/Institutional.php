...
Institutional::setAction();

class Institutional extends Bootstrap {

    public $module = "";
    public $permissao_ref = "institucional-paginas";
    ...
    function __construct() {
        ...
        $this->module_link = "institutional";
        $this->module_title = "Institucional";
        $this->retorno = "institutional";
    ...
    private function indexAction() {
        ...
        $this->list = $this->DB_fetch_array("SELECT A.*, B.nome categoria FROM $this->table A INNER JOIN tb_institucional_categorias B ON B.id = A.id_categoria WHERE A.id_categoria = 1 ORDER BY A.nome");
    ...
    private function saveAction() {
        ...
        if (!$validacao->return) {
            ...
            if (!$validacao->return) {
                ...
                if(!isset($data->listar_produtos)) $data->listar_produtos = 0;
