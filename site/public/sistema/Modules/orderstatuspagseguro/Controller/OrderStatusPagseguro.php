...
OrderStatusPagseguro::setAction();

class OrderStatusPagseguro extends Bootstrap {

    public $module = "";
    public $permissao_ref = "pedidos-status";
    public $table = "tb_pedidos_status_pagseguro";
    ...
    function __construct() {
        ...
        $this->module_link = "orderstatuspagseguro";
        $this->module_title = "Status de Pagamento do Pagseguro";
        $this->retorno = "orderstatuspagseguro";
    }
    ...
    private function delAction() {
        ...
        $this->inserirRelatorio("Apagou status da pagseguro: [" . $dados->rows[0]['nome'] . "] id: [$id]");
        ...
        if (!$validacao->return) {
            ...
            if ($formulario->id == "") {
                ...
                if ($query->query) {
                    ...
                    $this->inserirRelatorio("Cadastrou status da pagseguro: [" . $data->nome . "]");
                } else {
                    $resposta->type = "error";
                ...
                if ($query) {
                    ...
                    $this->inserirRelatorio("Alterou status da pagseguro: [" . $data->nome . "]");
                } else {
                    $resposta->type = "error";
                    $resposta->message = "Aconteceu um erro no sistema, favor tente novamente mais tarde!";
                }
