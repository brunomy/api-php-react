...
BannerSeveralTitle::setAction();

class BannerSeveralTitle extends Bootstrap {
    ...
    function __construct() {
        ...
        $this->module_link = "bannerseveraltitle";
        $this->module_title = "Banners Avulsos com Título";
        $this->retorno = "bannerseveraltitle";

        $this->id = 1;

        $this->banner1_uploaded = "";
        $this->crop_image1_sizes = array();
        array_push($this->crop_image1_sizes, array("width" => 769, "height" => 258));

        $this->banner2_uploaded = "";
        $this->crop_image2_sizes = array();
        array_push($this->crop_image2_sizes, array("width" => 353, "height" => 258));
    }
            ...
            if (!$validacao->return) {
                ...
                if ($formulario->id == "") {
                    ...
                    if ($query) {
                        ...
                        $this->inserirRelatorio("Alterou banner avulso com título: [" . $data->titulo . "]");
                    } else {
                        $resposta->type = "error";
