...
ChipsModel::setAction();

class ChipsModel extends Bootstrap {

    public $module = "";
    public $permissao_ref = "fichas-modelo";
    public $table = "tb_fichas_modelos";
    ...
    function __construct() {
        ...
        $this->module_icon = "wpzoom-cd";
        $this->module_link = "chipsmodel";
        $this->module_title = "Modelo de Fichas";
        $this->retorno = "chipsmodel";
    ...
    private function indexAction() {
        ...
        $this->list = $this->DB_fetch_array("SELECT A.* FROM tb_fichas_modelos A ORDER BY A.nome");
    ...
    private function delAction() {
        ...
        $this->inserirRelatorio("Apagou modelo de ficha: [" . $dados->rows[0]['nome'] . "] id: [$id]");
        ...
        if (!$validacao->return) {
            ...
            if ($formulario->id == "") {
                ...
                if ($query->query) {
                    ...
                    $this->inserirRelatorio("Cadastrou modelo de ficha: [" . $data->nome . "], id [$query->insert_id]");
                } else {
                    $resposta->type = "error";
                ...
                if ($query) {
                    ...
                    $this->inserirRelatorio("Alterou modelo de ficha: [" . $data->nome . "], id: [$data->id]");
                } else {
                    $resposta->type = "error";
                    $resposta->message = "Aconteceu um erro no sistema, favor tente novamente mais tarde!";
                }
