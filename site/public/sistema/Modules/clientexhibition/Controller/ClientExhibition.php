...
ClientExhibition::setAction();

class ClientExhibition extends Bootstrap {

    public $module = "";
    public $permissao_ref = "clientes-vitrine";
    public $table = "tb_clientes_vitrine";
    ...
    function __construct() {
        ...
        $this->module_icon = "icomoon-icon-user-3";
        $this->module_link = "clientexhibition";
        $this->module_title = "Clientes - Vitrine";
        $this->retorno = "clientexhibition";
        $this->banner_uploaded = "";

        $this->crop_sizes = array();

        array_push($this->crop_sizes, array("width" => 150, "height" => 150, "best_fit" => true));
    }
    ...
    private function delAction() {
        ...
        $this->inserirRelatorio("Apagou cliente vitrine: [" . $dados->rows[0]['nome'] . "] id: [$id]");
            ...
            if (!$validacao->return) {
                ...
                if ($formulario->id == "") {
                    ...
                    if ($query->query) {
                        ...
                        $this->inserirRelatorio("Cadastrou cliente vitrine: [" . $data->nome . "]");
                    } else {
                        $resposta->type = "error";
                    ...
                    if ($query) {
                        ...
                        $this->inserirRelatorio("Alterou cliente vitrine: [" . $data->nome . "]");
                    } else {
                        $resposta->type = "error";
                        $resposta->message = "Aconteceu um erro no sistema, favor tente novamente mais tarde!";
                    }
