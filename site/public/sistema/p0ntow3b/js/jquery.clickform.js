...
(function ($) {
            ...
            $cf.divs.blockerMessage.fadeOut(function () {
                ...
                if ($cf.response.type == "success") {
                    ...
                    if ($cf.response.message == null || $cf.response.message == "" || typeof $cf.response.message === "undefined") {
                        ...
                        complemento = "";
                        if($cf.config.validateUrl == "../scripts/form-ponto.php"){
                            complemento = ' style="padding-left:45px;background-image:url(img/icon_picture.png);background-position: 12px 10px;background-size:25px 25px;"';
                            $cf.config.waitTimeMessage = 5000;
                        }
                        $cf.divs.blockerMessage = $("<div style=\"display:none;\"><span"+complemento+"></span></div>");
    ...
    cssrules += "#clickformbodywrap     {position:relative;width:100%;height:100%;webkit-transition:0.4s;-0-transition:0.4s;transition:0.4s;}";
    ...
    cssrules += ".errorElement          {border:1px solid;border-color: red !important;}";
    ...
    $("#app_container").wrapInner('<div id="clickformbodywrap"></div>');
