...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="images/ico/favicon.ico" type="image/png">
            ...
            <div class="error-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-body">
                    <div class="page-header">
                        <h1 class="text-center mb25" style="background-color: #000; font-size: 7em;">><img src="<?php echo $sistema->getImageFileSized($empresa['logomarca'],370,141); ?>" alt="<?php echo $empresa['nome']; ?>">
                        </h1>
                    </div>
                    <h2 class="text-center mt30 mb30">Estamos em manutenção para melhor atender você. Até às 21h o site estará disponível novamente</h2>
                </div>
            </div>
        </div>
        <!-- Javascripts -->
