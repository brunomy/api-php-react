...
<div class="cartao_cielo">
	<form class="form_cartao_cielo" action="javascript:;" method="post">
		...
		<?php else: ?>
			<div class="titulo">DIGITE OS DADOS DO CARTÃO</div>
			<div class="greenlock"><img src="img/icon_green_lock.png" alt="ambiente seguro"> Ambiente 100% seguro</div>
			...
			<div class="comp-grid-row">
				<div class="comp-forms-grid-once comp-forms-item">
					<label>
						...
						<input type="text" name="SecurityCode" class='security_code' style="width: 70px;">
						<img src="img/icon_security_code.png" class="fr">
					</label>
				</div>
			</div>
			<div class="total">TOTAL A PAGAR: R$ <?php echo $sistema->formataMoedaShow($pedido['valor_final']) ?></div>
			<div class="comp-grid-row">
				<div class="comp-forms-grid-third-mobile comp-forms-item cemporcentoseguro">
					
				</div>
				<div class="comp-forms-grid-twothird-mobile comp-forms-item">
					<button class="clickformsubmit">PAGAR</button>
				</div>
			</div>
			<div class="comp-grid-row cancel_link">
				<a href="#" class="btn_cancel">(x) <span>cancelar</span></a>
			</div>
		<?php endif ?>
	</form>
</div>
...
//https://github.com/moiplabs/moipjs
	...
	$('input[name=ExpirationDate]').inputmask({'mask': '99/99'});
